...
def double_a_float():
    ...
    # -------------------------------------------------------------------------
    x = float(input('Put a floating point number: '))
    print(2*x)
...
def print_an_integer_many_times():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = int(input('Put a positive integer: '))
    for k in range(x):
        print(x*2)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = float(input('Put a positive floating point number: '))
    y = int(input('Put a positive integer: '))
    z = str(input('Put a string: '))
    for k in range(y):
        print(math.sqrt(x))
    for k in range(y):
        print(z)
